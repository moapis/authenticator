module github.com/moapis/authenticator
...
require (
	...
	github.com/moapis/ehtml v0.2.1
	github.com/moapis/mailer v0.2.1
	github.com/moapis/multidb v0.1.3
	...
	github.com/usrpro/clog15 v0.0.0-20200404182440-e3e24728322d
